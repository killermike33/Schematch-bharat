...
const CATEGORY_COLORS = {
  ...
  'Women & Children':     { bg: 'bg-pink-50',    text: 'text-pink-700',   border: 'border-pink-200' },
  'Health':               { bg: 'bg-red-50',     text: 'text-red-700',    border: 'border-red-200' },
  'Housing':              { bg: 'bg-yellow-50',  text: 'text-yellow-700', border: 'border-yellow-200' },
  'Employment & Skill':   { bg: 'bg-orange-50',  text: 'text-orange-700', border: 'border-orange-200' },
  'Social Welfare':       { bg: 'bg-purple-50',  text: 'text-purple-700', border: 'border-purple-200' },
  'Finance & Banking':    { bg: 'bg-teal-50',    text: 'text-teal-700',   border: 'border-teal-200' },
  'Energy':               { bg: 'bg-amber-50',   text: 'text-amber-700',  border: 'border-amber-200' },
  'Infrastructure':       { bg: 'bg-stone-50',   text: 'text-stone-700',  border: 'border-stone-200' },
  'Minority & SC/ST':     { bg: 'bg-lime-50',    text: 'text-lime-700',   border: 'border-lime-200' },
    ...
    <div className="scheme-card bg-white rounded-2xl border border-gray-200 shadow-card
          ...
          <div className="flex items-start gap-3 flex-1 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <div className="flex items-center gap-2 mt-0.5 flex-wrap">
                {scheme.issuing_body && (
                  <p className="text-xs text-gray-400 truncate">{scheme.issuing_body}</p>
                )}
                {scheme.state && (
      ...
      <div className="px-6 pb-5 flex items-center justify-between">
        ...
        {scheme.application_link ? (
          ...
          <span className="text-xs text-gray-400 italic">Visit state portal to apply</span>
        )}
      </div>
    </div>
  )
